...
public class Define {
    ...
    //hero
    public static final int HERO_LIFE = 500;
    public static final int BASIC_HERO_SPRITE_SIZE = 32;
    ...
    //enemy
    public static final double SKELETON_DAMAGE = 1.5;
    public static final double DWARF_DAMAGE = 1.5;
    public static final double GOBLIN_DAMAGE = 1.5;
    public static final double GIRL_DAMAGE = 1.5;
    public static final double MINOTAUR_DAMAGE = 1.5;
    public static final double ORC_DAMAGE = 1.5;


    public static final int DETECTION_RADIUS = 4000;

    public static final int DAMAGE_WIDTH = 160;
    public static final int DAMAGE_HEIGHT = 160;
    public static final int DAMAGE_OFFSET_X = -40;
    public static final int DAMAGE_OFFSET_Y = -40;

    public static final float BASIC_ENEMY_ACCELERATION = 1f;
    ...
    public static final int MOB_GIRL_SPRITE_SIZE = 48;
    public static final int MOB_SPRITE_SIZE = 32;
